...
const CreateShortLinkModal = ({ onClose, onSubmit, error, loading }) => {
  ...
  const handleClear = () => {
    setLinkData({
      originalUrl: "",
      remarks: "",
      expiration: "", // Reset expiration field
    });
  };

  const toggleExpiration = (checked) => {
    setIsExpirationEnabled(checked); // Update state based on switch status
  };
  return (
    <div className="modal-overlay">
      <div className="modal-container">
        <div className="header">
          <p className="new-link">New Link</p>
...
//           <h2 className="modal-header">
//             <div className="remarks">
//               Remarks <span className="red-star"> *</span>
//             </div>
//           </h2>
//           <textarea
//             name="remarks"
...
//             <button type="submit" className={`modal-submit-btn ${loading ? "loading" : ""}`} disabled={loading}>
//               {loading ? "Creating..." : "Create New"}
//             </button>
//           </div>
//         </form>
